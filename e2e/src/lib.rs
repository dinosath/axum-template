...
use std::sync::Arc;
use testcontainers::core::{ContainerPort, IntoContainerPort, WaitFor, logs::consumer::logging_consumer::LoggingConsumer};
...
/// Playwright browser wrapper for tests
...
/// Rstest fixture for Playwright browser
#[fixture]
pub async fn browser() -> TestBrowser {
    TestBrowser::new().await
}

/// Rstest fixture for HTTP client
#[fixture]
